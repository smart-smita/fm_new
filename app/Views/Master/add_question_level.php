    ...
    ajax_call(url,formData,$(obj),function(responce){
                        try{
                            ...
                            if(responce.status==1){
                                    ...
                                    $("#<?=$form_id?>").find("#division_dept").val(responce.data.division_dept);
                                    ...
                                    $("#<?=$form_id?>").find("#after_photo").val(responce.data.after_photo);
