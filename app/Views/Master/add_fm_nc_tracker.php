...
<!--begin::Item-->
	<li class="breadcrumb-item text-muted">
		...
		<a href="<?= base_url('Masters/Fm_nc_tracker') ?>" class="text-muted text-hover-primary"><?=isset($title)?$title:"Client"?></a>
	</li>
<!--end::Item-->
<?php $this->endSection();?>	
                    	...
                    	<div class="scroll-y me-n7 pe-7" id="user" data-kt-scroll="false" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#fees_head" data-kt-scroll-offset="300px" style="max-height: 70vh;">
								...
								<div class="row mb-12">
                                  ...
                                  <div class="col-md-12 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="twocol">
                                     <div class="col-md-12 fv-row fv-plugins-icon-container">
                                        <!-- NEW CHANGES: Make FM Leased read-only and show NO -->
                                        <label class="fs-5 fw-bold mb-2">Fm Leased </label>
                                        <input type="text" class="form-control form-control-solid"  id="fm_leased" name="fm_leased" value="NO" disabled>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                     <div class="col-md-12 fv-row fv-plugins-icon-container">
									 ...
									 <div class="col-md-12 fv-row fv-plugins-icon-container">
										...
										<input type="hidden" id="before_photo_url" name="before_photo_url">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
    ...
    ajax_call(url,formData,$(obj),function(responce){
                        try{
                            ...
                            if(responce.status==1){
                                    ...
                                    // NEW CHANGES: Keep FM leased as NO
                                    $("#<?=$form_id?>").find("#fm_leased").val("NO").prop("disabled", true); 
...
// NEW CHANGES: Add status update function for FM NC Tracker
function updateFmStatus(id, status) {
    $.post('<?= base_url('Masters/Fm_nc_tracker/update_nc_status') ?>', { id: id, status: status })
        .always(function() {
...
<!-- changes on 30/09/25 by darsh: hide Add button on FM NC Tracker page only -->
<script>
