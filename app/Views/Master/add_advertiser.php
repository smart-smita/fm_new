...
<!--begin::Item-->
	<li class="breadcrumb-item text-muted">
		<a href="<?= current_url() ?>" class="text-muted text-hover-primary">Advertiser Details</a>
	</li>
<!--end::Item-->
<?php $this->endSection();?>	
                    	...
                    	<div class="scroll-y me-n7 pe-7" id="customer" data-kt-scroll="false" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#customer" data-kt-scroll-offset="300px" style="max-height: 273px;">
								...
								<div class="row mb-12">
									...
									<div class="col-md-12 fv-row fv-plugins-icon-container">
										<label class="required fs-5 fw-bold mb-2"> Advertiser Name </label>
										<input type="text" class="form-control form-control-solid" placeholder="Please enter Name" id="advertiser_name" name="advertiser_name">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									
									
									<div class="col-md-12 fv-row fv-plugins-icon-container">
										<label class="required fs-5 fw-bold mb-2">Advertiser Email </label>
										<input type="text" class="form-control form-control-solid" placeholder="Please enter Email" id="advertiser_email" name="advertiser_email">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									
									<div class="col-md-12 fv-row fv-plugins-icon-container">
										<label class="required fs-5 fw-bold mb-2">Advertiser Contact </label>
										<input type="text" class="form-control form-control-solid" placeholder="Please enter Contact" id="advertiser_contact" name="advertiser_contact">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									
									<div class="col-md-12 fv-row fv-plugins-icon-container">
										<label class="required fs-5 fw-bold mb-2">Screen Count </label>
										<input type="text" class="form-control form-control-solid" placeholder="Please enter Screen Count" id="screen_count" name="screen_count">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
									
									<div class="col-md-12 fv-row fv-plugins-icon-container">
										<label class="required fs-5 fw-bold mb-2">Location </label>
										<input type="text" class="form-control form-control-solid" placeholder="Please enter location" id="advertiser_location" name="advertiser_location">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
...
var validation_object  = {
        fields: {
            ...
            'screen_count': {
                validators: {
                    notEmpty: {
                        message: 'Screen Count is required'
                    }
                }
            },
             'advertiser_location': {
    ...
    ajax_call(url,formData,$(obj),function(responce){
                        try{
                            ...
                            if(responce.status==1){
                                    ...
                                    //form.reset();
                                    // to update value 
                                    $("#<?=$form_id?>").find("#advertiser_name").val(responce.data.advertiser_name);
                                    $("#<?=$form_id?>").find("#advertiser_email").val(responce.data.advertiser_email);
                                    $("#<?=$form_id?>").find("#advertiser_contact").val(responce.data.advertiser_contact);
                                    $("#<?=$form_id?>").find("#screen_count").val(responce.data.screen_count);
                                    $("#<?=$form_id?>").find("#advertiser_location").val(responce.data.advertiser_location);
