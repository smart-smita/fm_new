...
<li class="breadcrumb-item text-muted">
    <a><?=isset($title)?$title:"Site Category"?></a>
</li>
<!--end::Item-->
<?php $this->endSection();?>	
                ...
                <div class="scroll-y me-n7 pe-7" id="user" data-kt-scroll="false" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#fees_head" data-kt-scroll-offset="300px" style="max-height: 273px;">
                    ...
                    <div class="row mb-12">
                        ...
                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                            <label class="required fs-5 fw-bold-2">Site Category Name</label>
                            <input type="text" class="form-control form-control-solid" placeholder="Site Category Name" id="site_category_name" name="site_category_name">
...
var validation_object  = {
    fields: {
        'site_category_name': {
            validators: {
                notEmpty: {
                    message: 'Site Category Name is required'
                }
            }
        }
    },
...
function edit_id(obj,id){
    ...
    ajax_call(url,formData,$(obj),function(responce){
        try{
            ...
            if(responce.status==1){
                toastr.success(responce.message);
                $("#<?=$form_id?>").find("#site_category_name").val(responce.data.site_category_name);
