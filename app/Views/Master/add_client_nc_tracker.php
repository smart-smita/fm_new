...
<!--begin::Item-->
	<li class="breadcrumb-item text-muted">
		...
		<a href="<?= base_url('Masters/Client_nc_tracker') ?>" class="text-muted text-hover-primary"><?=isset($title)?$title:"Client"?></a>
	</li>
<!--end::Item-->
<?php $this->endSection();?>	
...
<!--    <div class="col-md-4">-->
<!--        <a href="<?= base_url('Masters/Client_nc_tracker/template_type_filter/Open'); ?>" class="card bg-primary hoverable mb-xl-8">-->
            <!--begin::Body-->
...
<!--    <div class="col-md-4">-->
<!--        <a href="<?= base_url('Masters/Client_nc_tracker/template_type_filter/Close'); ?>" class="card bg-dark hoverable mb-xl-8">-->
<!--            <div class="card-body" style="padding: 1rem 2.25rem;">-->
...
<!--        <a href="<?= base_url('Masters/Client_nc_tracker/template_type_filter/Working'); ?>" class="card bg-info hoverable mb-5 mb-xl-8">-->
<!--            <div class="card-body" style="padding: 1rem 2.25rem;">-->
                    	...
                    	<div class="scroll-y me-n7 pe-7" id="user" data-kt-scroll="false" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#fees_head" data-kt-scroll-offset="300px" style="max-height: 70vh;">
								...
								<div class="row mb-12">
                                  ...
                                  <div class="col-md-12 fv-row fv-plugins-icon-container">
									 ...
									 <div class="col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="fs-5 fw-bold mb-2">Site Category</label>
                                    ...
                                    <div class="twocol">
                                    <div class="col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="fs-5 fw-bold mb-2">Client Leased </label>
                                        <!-- NEW CHANGES: Display fixed NO, non-editable -->
                                        <input type="text" class="form-control form-control-solid"  id="client_leased" name="client_leased" value="NO" disabled>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                     <div class="col-md-12 fv-row fv-plugins-icon-container">
									 ...
									 <div class="col-md-12 fv-row fv-plugins-icon-container">
                                        <label class="fs-5 fw-bold mb-2">Nc Status</label>
										<input type="text" class="form-control form-control-solid"  id="nc_status" name="nc_status">
										<div class="fv-plugins-message-container invalid-feedback"></div>
									</div>
                                    <div class="col-md-12 fv-row fv-plugins-icon-container">
                                    ...
                                    <!-- changes on 6/10/25 by darsh: make before photo clickable and show small preview -->
                                    <script>
                                    (function(){
    ...
    $('form').on('submit', function(e) {
        ...
        if (activeElement && activeElement.tagName === 'TEXTAREA') {
            ...
            return false;
                        ...
                        // NEW CHANGES: Silent status updates; no confirmation/toasts
                        function updateNcStatus(id, status) {
                            $.ajax({
                                url: '<?= base_url('Masters/Client_nc_tracker/update_nc_status') ?>',
                                method: 'POST',
