...
<html lang="en">
	...
	<title>DG PLAY</title>
<meta charset="utf-8" />
<meta name="description" content="DG PLAY ADVERTISEMENT APP" />
<meta name="keywords" content="DG PLAY ADVERTISEMENT APP" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="" />
<meta property="og:url" content="DGPLAY ADVERTISEMENT APP" />
<meta property="og:site_name" content="DGPLAY ADVERTISEMENT APP" />
<link rel=" canonical " href="" />
<link rel="shortcut icon " href="<?=base_url()?>/assets/media/Mobiyoung-Logo.jpeg" />
		<!--begin::Fonts-->
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="<?=base_url()?>" class="py-9 mb-5">
								<img alt="Logo" src="<?=base_url()?>/assets/media/Mobiyoung-Logo.jpeg" class="h-60px" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to DG PLAY</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: #986923;">Discover Amazing DG PLAY 
				...
				<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_password_reset_form">
								...
								<div class="text-center mb-10">
									...
									<!--end::Title-->
									<!--begin::Link-->
									<div class=" fw-bold fs-4" style="color:#986923">Enter your email to reset your password.</div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="<?=base_url()?>/Login" class="btn btn-lg btn-light-primary fw-bolder">Cancel</a>
								</div>
								<!--end::Actions-->
							<div></div></form>
							<!--end::Form-->
