...
<body>
    <div class="email-wrapper">
        ...
        <div class="body-content">
            <div class="greeting">
                <p style="margin-top:0;"><strong>Dear Team,</strong></p>
                <p>A Non-Conformance (NC) status has been rejected and sent back to Open status.</p>
            </div>
            ...
            <div class="alert-box">
                &#9888;&#65039; &nbsp; Please review the rejected NC and provide the necessary CAPA/actions.
            </div>
            ...
            <div class="footer-action">
                ...
                <div class="footer-right">
                    <a href="<?= esc($action_link) ?>" class="btn">&#128065;&#65039; VIEW TRACKER</a>
                </div>
            </div>
        </div>
