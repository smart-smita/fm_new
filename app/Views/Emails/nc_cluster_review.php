...
<head>
    ...
    <title>HSE NC Submitted for Cluster Review</title>
    <style>
        body {
...
<body>
    <div class="email-wrapper">
        ...
        <div class="body-content">
            <div class="greeting">
                <p style="margin-top:0;"><strong>Dear Cluster Manager,</strong></p>
                <p>A Non-Conformance (NC) has been submitted by the Account Manager and is awaiting your review.</p>
            </div>
            ...
            <div class="status-box">
                ...
                <span class="status-badge">CLUSTER REVIEW</span>
            </div>

            <div class="alert-box">
                &#9888;&#65039; &nbsp; Please review the NC and take necessary action.
            </div>
