...
<head>
    ...
    <title>HSE NC Closed Successfully</title>
    <style>
        body {
    ...
    <div class="email-wrapper">
        ...
        <div class="body-content">
            <div class="greeting">
                ...
                <p>A Non-Conformance (NC) has been reviewed and closed successfully.</p>
            </div>
            ...
            <div class="details-box">
                <table class="data-table">
                    ...
                    <?php if (!empty($closed_date)): ?>
                        <tr>
                            <th>Closed Date</th>
                            <td><?= esc($closed_date) ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if (!empty($closure_remark)): ?>
                        <tr>
                            <th>Closure Remark</th>
                            <td><?= esc($closure_remark) ?></td>
                        </tr>
                    <?php endif; ?>
                </table>
            </div>
            ...
            <div class="status-box">
                <span class="status-label">&#10004;&#65039; CURRENT STATUS</span>
                <span class="status-badge">CLOSED</span>
            </div>

            <div class="alert-box">
                &#10004;&#65039; &nbsp; The NC has been closed successfully.
            </div>
            ...
            <div class="footer-action">
                ...
                <div class="footer-right">
                    <a href="<?= esc($action_link) ?>" class="btn">&#128196; VIEW DETAILS</a>
                </div>
            </div>
        </div>
